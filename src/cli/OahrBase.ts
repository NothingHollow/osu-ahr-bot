...
import { PlayerInteractor } from '../plugins/PlayerInteractor';
import { BotCommand } from '../plugins/BotCommand';
import { StatSaver } from '../plugins/StatSaver';
...
export class OahrBase {
  ...
  constructor(client: IIrcClient) {
    ...
    this.interactor = new PlayerInteractor(this.lobby);
    this.command = new BotCommand(this.lobby);
    this.stat = new StatSaver(this.lobby);
