...
export class LobbyKeeper extends LobbyPlugin {
  ...
  private onKickedPlayer(u: User): void {
    ...
    this.lobby.SendPrivateMessageWithCoolTime('You kicked a Player in the Room, another violation will resorted to punishment', p.escaped_name, 'hostKickWarn', 5000);
